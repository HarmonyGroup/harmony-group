...
const Hero = () => {
  ...
  return (
    <section className="relative bg-[url(https://images.unsplash.com/photo-1498049860654-af1a5c566876?q=80&w=2970&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)] bg-cover bg-center bg-no-repeat overflow-x-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-5 py-32 flex h-[100vh] lg:h-[100vh] items-center">
        <div className="w-full text-center mt-0 sm:mt-10" ref={heroRef}>
          <h1 className="text-3xl text-center font-extrabold text-white sm:text-6xl mt-6">
            Building a network <br /> of{" "}
            <span className="text-orange-600">remarkable</span> people
          </h1>
